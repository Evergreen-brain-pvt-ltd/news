...
<body class="animsition yyyyimgg">
	<div class="yyyyimg">
		<!-- Header -->
		<header>
			<!-- Header desktop -->
			<div class="container-menu-desktop">
					...
					<div class="content-topbar container h-100">
						<div class="left-topbar">
							<span class="left-topbar-item flex-wr-s-c">
								<img class="m-b-1 m-rl-8" src="images/pp.png" alt="IMG" style="width: 181px !important; margin-left:-166px !important;">
							</span>
				...
				<div class="wrap-header-mobile">
					...
					<div class="logo-mobile">
						<a href="index.html"><img src="images/pp.png" alt="IMG-LOGO"></a>
					</div>
				...
				<div class="menu-mobile">
					<ul class="topbar-mobile">
						<li class="left-topbar">
							<span class="left-topbar-item flex-wr-s-c">
								...
								<img class="m-b-1 m-rl-8" src="images/pp.png" alt="IMG" style="width: 100%!important;">
					...
					<!-- <li>
						<a href="category-01.html">Partner Zone</a>
					</li>

					<li>
						<a href="category-02.html">Partner Zone </a>
					</li>
				...
				<!-- <div class="wrap-main-nav">
					<div class="main-nav">
						Menu desktop--comment
						<nav class="menu-desktop">
							<div class="wrap-logo container">

								Logo desktop--comment
							...
							<a class="logo-stick" href="index.html">
								<img src="images/pp.png" alt="LOGO">
							</a>
				
			</li>

				<li class="mega-menu-item">
					<a href="category-02.html">Expert Hub </a>
							...
							<div class="tab-pane show active" id="enter-1" role="tabpanel">
								<div class="row">
									<div class="col-3">
										...
										<div> <a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
												<img src="images/post-25.jpg" alt="IMG"> </a>
				...
				<li class="mega-menu-item">
					<a href="category-01.html">Training </a>
				...
				<li class="mega-menu-item">
					<a href="category-02.html">Specials</a>
					<div class="sub-mega-menu">
						<div class="nav flex-column nav-pills" role="tablist">
	...
	<!-- Headline -->
	<div class="container iiiii">
		<div class="wrap-logo container">
			<!-- Logo desktop -->
			<div class="wrap-logo container">
				<!-- Logo desktop -->
				<div class="logo">
					<a href="index.html"><img src="images/pp.png" alt="LOGO"></a>
				</div>
		...
		<ul class="main-menu">
			<li class="main-menu-active">
				...
				<ul class="sub-menu">
					<li><a href="index.html">News v1</a></li>
					<li><a href="home-02.html">News v2</a></li>
			...
			<li class="mega-menu-item">
				...
				<div class="sub-mega-menu">
					<div class="nav flex-column nav-pills" role="tablist">
						<a class="nav-link active" data-toggle="pill" href="#news-0" role="tab" aria-expanded="true">All</a>
						<a class="nav-link" data-toggle="pill" href="#news-1" role="tab" aria-expanded="false">Entertaiment</a>
							...
							<div class="row">
								<div class="col-3">
									...
									<div>
										...
										<div class="p-t-10">
											<h5 class="p-b-5"> <a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">
													Donec metus orci, malesuada et lectus vitae </a>
											</h5>
											<span class="cl8">
												<a href="#" class="f1-s-6 cl8 hov-cl10 trans-03">
													Music
												</a> <span class="f1-s-3 m-rl-3"> -
												</span>
												<span class="f1-s-3">
													Feb 18 </span> </span>
										</div>
								...
								<div class="col-3">
									...
									<div>
										<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
											<img src="images/post-10.jpg" alt="IMG"></a>
										<div class="p-t-10">
											<h5 class="p-b-5">
												<a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">
													Donec metus orci, malesuada et lectus vitae
								...
								<div class="col-3">
									...
									<div>
										...
										<div class="p-t-10">
											...
											<span class="cl8">
												<a href="#" class="f1-s-6 cl8 hov-cl10 trans-03"> Technology</a>
												<span class="f1-s-3 m-rl-3">-
												</span>
												<span class="f1-s-3">Jan 20
												</span>
											</span>
										</div>
									</div>
							...
							<div class="row">
								...
								<div class="col-3">
									...
									<div>
										...
										<div class="p-t-10">
											<h5 class="p-b-5">
												<a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">Donec metus orci, malesuada et lectus vitae</a>
											</h5><span class="cl8">
												<a href="#" class="f1-s-6 cl8 hov-cl10 trans-03">
													Music
												</a><span class="f1-s-3 m-rl-3">
							...
							<div class="row">
								...
								<div class="col-3">
									...
									<div>
										...
										<div class="p-t-10">
											<h5 class="p-b-5"> <a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03"> Donec metus orci, malesuada et lectus vitae
												</a>
											</h5>
											<span class="cl8">
												<a href="#" class="f1-s-6 cl8 hov-cl10 trans-03">
								...
								<div class="col-3">
									...
									<div>
										...
										<div class="p-t-10">
											...
											<span class="cl8">
												<a href="#" class="f1-s-6 cl8 hov-cl10 trans-03"> Music</a>
												<span class="f1-s-3 m-rl-3">
													-</span>
												<span class="f1-s-3">
													Feb 12</span>
						...
						<div class="tab-pane" id="news-3" role="tabpanel">
							<div class="row">
								...
								<div class="col-3">
									<!-- Item post -->
									<div>
										<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03"><img src="images/post-27.jpg" alt="IMG">
										</a>
										<div class="p-t-10">
											<h5 class="p-b-5">
												<a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">
								...
								<div class="col-3">
									<!-- Item post -->
									<div>
										<a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03"><img src="images/post-26.jpg" alt="IMG">
										</a>
										<div class="p-t-10">
											<h5 class="p-b-5">
												<a href="blog-detail-01.html" class="f1-s-5 cl3 hov-cl10 trans-03">
			...
			<li class="mega-menu-item">
				...
				<div class="sub-mega-menu">
					<div class="nav flex-column nav-pills" role="tablist">
						<a class="nav-link" data-toggle="pill" href="#enter-1" role="tab" aria-expanded="false">All</a>
						<a class="nav-link" data-toggle="pill" href="#enter-2" role="tab" aria-expanded="false">Game</a>
						<a class="nav-link active" data-toggle="pill" href="#enter-3" role="tab" aria-expanded="true">Celebrity</a>
					</div>

					<div class="tab-content">
						<div class="tab-pane" id="enter-1" role="tabpanel" aria-expanded="false">
							<div class="row">
								<div class="col-3">
									<!-- Item post -->
									<div>
						...
						<div class="tab-pane active" id="enter-3" role="tabpanel" aria-expanded="true">
							<div class="row">
								<div class="col-3">
									<!-- Item post -->
									<div>
	...
	<section class="bg0 p-t-70">
		<div class="container iii">
			<div class="row iii justify-content-center">
				...
				<div class="row">
					<div class="col-lg-4 p-b-20">
						<div class="size-h-3 flex-s-c">
							<a href="index.html">
								<img class="max-s-full" src="images/tropical_logo_white.png" alt="LOGO">
							</a>
						</div>
			...
			<div class="container size-h-4 flex-c-c p-tb-15">
				<span class="f1-s-1 cl0 txt-center">
					...
					<a href="#" class="f1-s-1 cl10 hov-link1">
						...
						</script> All rights reserved | © Travelmole Media LLC 2022 <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank"></a>
				</span>
			</div>
		</div>
	</footer>
